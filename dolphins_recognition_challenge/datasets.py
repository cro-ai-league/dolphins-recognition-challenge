...
__all__ = ['stack_imgs', 'display_batches', 'get_image2tensor_transforms', 'get_dataset']
...
def stack_imgs(imgs: List[PIL.Image.Image], width=None) -> PIL.Image:
...
def display_batches(data_loader: torch.utils.data.DataLoader, *, n_batches: int=1, width:int=600, show_y: bool=False):
    """ Displays `n_batches`
    """
