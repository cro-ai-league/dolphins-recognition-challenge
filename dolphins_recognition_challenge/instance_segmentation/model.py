...
__all__ = ['train_one_epoch', 'show_prediction', 'show_predictions', 'iou_metric_mask_pair',
           'iou_metric_matrix_of_example', 'largest_values_in_row_colums', 'iou_metric_matched_of_example',
           'iou_metric']
...
def iou_metric_matched_of_example(
    model: torchvision.models.detection.mask_rcnn.MaskRCNN,
    example: Tuple[torch.Tensor, Dict[str, torch.Tensor]],
    score_threshold: float = 0.5,
) -> float:
...
def iou_metric(
    ...
    iou = [
        iou_metric_matched_of_example(model, data_loader.dataset[i], score_threshold)
